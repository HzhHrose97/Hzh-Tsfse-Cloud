...
public class GlobalLocationController {
    ...
    public MyResult globalLocationGetAll(){
        try {
            List<GlobalLocation> globalLocationList =  globalLocationService.globalLocationGetAll();
            return MyResult.SUCCESS("globalLocationGetAll success",globalLocationList);
        }catch (Exception e){
    ...
    public MyResult globalGetAllpagination(@RequestBody PaginationDTO paginationDTO){
        try {
            ...
            return MyResult.SUCCESS("globalGetAllpagination success",globalLocationIPage);
        }catch (Exception e){
