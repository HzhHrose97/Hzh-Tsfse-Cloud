...
@TableName("basketball_refund_order_info")
@ApiModel(value="BasketballRefundOrderInfo对象", description="篮球订单退款信息")
public class BasketballRefundOrderInfo implements Serializable {
