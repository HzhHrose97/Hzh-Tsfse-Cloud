...
public class BasketballPaymentInfoController {
    ...
    public Result getAllBasketBallInfo(){
        try {
            ...
            return Result.SUCCESS("getAllBasketBallInfo success",basketballPaymentInfos);
        }catch (Exception e){
    ...
    public Result pageGetAllBasketballOrderInfo(@RequestBody PaginationDTO paginationDTO){
        try {
            ...
            return Result.SUCCESS("pageGetAllBasketballOrderInfo success",basketballPaymentInfoIPage);
        }catch (Exception e){
